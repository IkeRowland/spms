...
const CoursePage = () => {
  ...
  const {loading, error, courses, success} = useSelector((state) => state.course);
  const [courseCode, setCourseCode] = useState("");
  const [courseName, setCourseName] = useState("");

  const handleCreateCourse = (e) => {
    e.preventDefault();
    dispatch(createCourse({course_code: courseCode, course_name: courseName}))
  }
      ...
      <section className='grid md:grid-cols-5'>
        <div className='col-span-3 pr-2'>
          <div className='bg-white p-2'>
            ...
            {/* All avaiable course => should be seen by admin */}
