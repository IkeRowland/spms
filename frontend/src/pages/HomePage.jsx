      ...
      {userInfo?.user?.user_type === "admin" && (
        <div className='bg-slate-100 shadow-sm p-4'>
          <div className='grid grid-cols-1 md:grid-cols-4 gap-3'>
            <Link to='/students' className='col-span-1 p-4 bg-gray-900 text-white flex flex-col justify-center items-center rounded'>
            ...
            <Link to='/lecturers' className='col-span-1 p-4 bg-amber-500 text-white flex flex-col justify-center items-center rounded'>
              <div className='h-16 w-16 bg-slate-100 rounded-full flex items-center justify-center text-gray-900 my-3'>
            ...
            <Link to='/courses' className='col-span-1 p-4 bg-gray-900 text-white flex flex-col justify-center items-center rounded'>
              <div className='h-16 w-16 bg-slate-100 rounded-full flex items-center justify-center text-gray-900 my-3'>
